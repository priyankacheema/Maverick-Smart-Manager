...
public class EnrollCoursePage extends Activity implements View.OnClickListener {

    TextView courseid,coursename,time,location,professor;
    String id,name,course_id;
    Button button,btEnroll;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_enroll_course_page);
        ...
        btEnroll = (Button)findViewById(R.id.btEnroll);
    ...
    class BackgroundTask extends AsyncTask<String, Void, String>
    {
        ...
        protected void onPreExecute() {
            ...
            add_info_url = "http://mavsuta.co.nf/InsertCourse.php";
        ...
        protected String doInBackground(String... args) {
            ...
            try {
                ...
                return "New Course Enrolled Successfully...";
